...
export type MessageFragmentFragment = { __typename?: 'Message', _id: string, content: string, createdAt: any, userId: string, chatId: string };
...
export type MessageCreatedSubscription = { __typename?: 'Subscription', messageCreated: { __typename?: 'Message', _id: string, content: string, createdAt: any, userId: string, chatId: string } };
